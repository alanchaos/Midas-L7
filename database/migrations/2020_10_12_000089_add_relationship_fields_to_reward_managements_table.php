...
class AddRelationshipFieldsToRewardManagementsTable extends Migration
{
    public function up()
    {
        Schema::table('reward_managements', function (Blueprint $table) {
            ...
            $table->foreign('merchant_id', 'merchant_fk_2380515')->references('id')->on('merchant_managements');
            ...
            $table->foreign('voucher_id', 'voucher_fk_2380524')->references('id')->on('voucher_managements');
        });
    }
}
